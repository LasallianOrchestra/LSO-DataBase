...
const CACHE_VERSION = 'lso-website-enterprise-v25';
...
const CORE_PATHS = [
  ...
  './duty-punch-organized-v10.css', './attendance-month-workspace-v2.css',
  ...
  './supabase-config.js', './branding.js', './lso-system-core-v1.js', './role-access-v2.js',
  './cloud.js', './app-member-information-v5.js', './auth-view-controller-v17.js', './auth.js',
  './management-attendance-member-info-v3.js', './ui-enhancements.js', './dashboard-enhancements.js',
  './renderall-compat-v25.js', './workflow-attendance-month-v2.js', './workflow-attendance-month-v3.js', './workflow-attendance-month-v4.js', './attendance-governance.js', './duty-hours-member-info-v11.js',
  './pdf-lib.min.js', './monthly-report-template-data.js', './monthly-report.js',
  './contract-template-data.js', './contract-maker-membership-v4.js',
  './dashboard-intelligence-member-info-v3.js', './permissions.js', './dashboard-command-center-v4.js',
  './login-logo-3d-v1.js', './system-enterprise-v1.js', './pwa-enterprise-v25.js',
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.origin === self.location.origin && /\/workflow-attendance-month-v[23]\.js$/i.test(url.pathname)) {
    const fixedUrl = new URL('./workflow-attendance-month-v4.js', SCOPE).toString();
