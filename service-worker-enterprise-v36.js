...
const CACHE_VERSION = 'lso-website-enterprise-v36';
...
const CORE_PATHS = [
  ...
  './refresh-mobile-scroll-v36.html',
  './styles.css',
  ...
  './mobile-scroll-compat-v36.css',
  './supabase-config.js',
  './branding-print-fullbleed-v31.js',
  './lso-system-core-v3.js',
  './role-access-v3.js',
  './cloud-staff-v4.js',
  ...
  './permissions-staff-v2.js',
  './dashboard-command-center-v5.js',
  './login-logo-3d-v1.js',
  './system-enterprise-v1.js',
  './mobile-scroll-controller-v36.js',
  './pwa-enterprise-v36.js',
  './favicon.ico',
  './favicon-32x32.png',
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.origin === self.location.origin && /\/(?:workflow-attendance-month-v[2-5]|management-attendance-member-info-v3|attendance-governance|duty-hours-member-info-v1[12]|auth-view-controller-v17|cloud-staff-v3)\.js$/i.test(url.pathname)) {
    const redirects = [
      ...
      [/cloud-staff/i, './cloud-staff-v4.js']
    ];
