(() => {
  ...
  const ACTIVE_WORKER = 'service-worker-enterprise-v35.js';
  const ACTIVE_CACHE_MARKER = 'enterprise-v35';
      ...
      registration.addEventListener('updatefound', () => {
        ...
        worker.addEventListener('statechange', () => {
          if (worker.state === 'installed' && navigator.serviceWorker.controller) {
            banner('A verified LSO update is ready. Applying it now…', 'online');
