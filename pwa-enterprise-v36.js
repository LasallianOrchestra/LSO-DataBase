(() => {
  ...
  const ACTIVE_WORKER = 'service-worker-enterprise-v36.js';
  const ACTIVE_CACHE_MARKER = 'enterprise-v36';
      ...
      registration.addEventListener('updatefound', () => {
        ...
        worker.addEventListener('statechange', () => {
          if (worker.state === 'installed' && navigator.serviceWorker.controller) {
            banner('A mobile compatibility update is ready. Applying it now…', 'online');
